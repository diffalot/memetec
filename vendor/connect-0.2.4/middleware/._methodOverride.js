...
var dep = require('path').join(__dirname, "vendor/.npm/connect/0.2.4/dependencies")
var depMet = require.paths.indexOf(dep) !== -1
var from = "vendor/.npm/connect/0.2.4/package/lib/connect/middleware/._methodOverride"
